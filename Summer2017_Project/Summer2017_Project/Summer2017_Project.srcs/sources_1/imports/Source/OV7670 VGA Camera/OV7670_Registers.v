...
module OV7670_Registers (
    ...
    always @ (posedge clk) begin
        ...
        case (address) 
            ...
            2 : sreg <= 16'h12_04;          // COM7     Size & RGB output
            3 : sreg <= 16'h11_00;            // CLKRC    Use internal clock
            4 : sreg <= 16'h0C_00;          // COM3     Default
            5 : sreg <= 16'h3E_00;          // COM14    Set to use normal PCLK            
            6 : sreg <= 16'h8C_00;          // RGB444   Disable RGB 444 format
            7 : sreg <= 16'h04_00;          // COM1     Disable CCIR 656
            8 : sreg <= 16'h40_10;          // COM15    Enable RGB 565 (effective only after disable RGB 444 format)
            9 : sreg <= 16'h3A_04;          // TSLB     Disable auto-reset window
            10 : sreg <= 16'h14_38;         // COM9     Set auto gain ceiling to x16 
            ...
            20 : sreg <= 16'h17_11;         // HSTART   Horizontal Frame start (high 8 bits)
            21 : sreg <= 16'h18_61;         // HSTOP    Horizontal Frame stop (high 8 bits)
            22 : sreg <= 16'h32_A4;         // HREF     set Horizontal Frame control
            23 : sreg <= 16'h19_03;         // VSTART   Vertical Frame start (high 8 bits)
            24 : sreg <= 16'h1A_7B;         // VSTOP    Vertical Frame stop (high 8 bits)
            ...
            29 : sreg <= 16'h1E_37;         // MVFP     detect mirror image and enable flip image
            ...
            43 : sreg <= 16'h74_10;         // REG74    default
            44 : sreg <= 16'h8D_4F;         // RSVD     reserve
            45 : sreg <= 16'h8E_00;         // RSVD     reserve
            46 : sreg <= 16'h8F_00;         // RSVD     reserve
            47 : sreg <= 16'h90_00;         // RSVD     reserve
            48 : sreg <= 16'h91_00;         // RSVD     reserve
            49 : sreg <= 16'h96_00;         // RSVD     reserve
            50 : sreg <= 16'h9A_00;         // RSVD     reserve
            51 : sreg <= 16'hB0_84;         // RSVD     reserve
            52 : sreg <= 16'hB1_0C;         // ABLC1    disable ABLC function
            53 : sreg <= 16'hB2_0E;         // RSVD     reserve
            54 : sreg <= 16'hB3_82;         // RSVD     reserve
            55 : sreg <= 16'hB8_0A;         // RSVD     reserve 
